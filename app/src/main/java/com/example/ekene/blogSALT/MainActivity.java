package com.example.ekene.blogSALT;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("BlogSALT");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogSALT, BlogzoneViewHolder> FBRA = new FirebaseRecyclerAdapter<BlogSALT, BlogzoneViewHolder>(
                BlogSALT.class,
                R.layout.card_items,
            ...
            @Override
            protected void populateViewHolder(BlogzoneViewHolder viewHolder, BlogSALT model, int position) {
